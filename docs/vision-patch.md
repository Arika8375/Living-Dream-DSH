...
$backupFile = "G:\qwenwork_files\dsh-host-apiproxy-index.js.bak"
...
创建 `G:\qwenwork_files\dsh_vision_config.json`：
...
async function describeImagesLocally(imagePaths) {
  const configPath = 'G:\\qwenwork_files\\dsh_vision_config.json';
...
- 备份文件在 `G:\qwenwork_files\dsh-host-apiproxy-index.js.bak`
