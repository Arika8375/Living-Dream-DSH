...
`D:\DeepSeek work space\dsh-file-uploads\client.js:168`
...
`D:\DeepSeek work space\dsh-file-uploads\index.js:43`
...
`D:\DeepSeek work space\dsh-file-uploads\index.js:40-56`
...
`D:\DeepSeek work space\dsh-file-uploads\index.js:213`
...
## 六、本地补丁问题专节（`D:\DeepSeek work space\dsh-local-patches-backup\`，当前未应用）
...
2. **[中] readVisionConfig 硬编码 `G:\qwenwork_files\dsh_vision_config.json`** —— 换机/换盘即失效。Fix=配置路径可配置/从设置读。
